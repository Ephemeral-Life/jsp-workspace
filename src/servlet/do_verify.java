...
/**
 * Servlet implementation class do_verifi
 */
@WebServlet("/do_verifi")
public class do_verify extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		// 验证码字符范围
		char[] ch = "ABCDEFGHIJKLMNPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz123456789".toCharArray();
		Random r = new Random();
		int index;
